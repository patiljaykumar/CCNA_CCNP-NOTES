...
- Sends Periodic updates (<ins>**every ==30s== by default**</ins>) \[Bandwidth overhead\]
- Max hop count limit is 15
- In 1 routing update Max limit- 25 net (if rip>25 net remaining net in another update)
    - <img src="../../_resources/62e831a199804cdda43c8640ea107f9f.png" alt="62e831a199804cdda43c8640ea107f9f.png" width="407" height="305" class="jop-noMdConv">
    - <img src="../../_resources/ec6d1a99e1d459db0742031b2d65f89b.png" alt="ec6d1a99e1d459db0742031b2d65f89b.png" width="223" height="135" class="jop-noMdConv">
...
- <img src="../../_resources/c75859aa4703f906784f649eec33075a.png" alt="c75859aa4703f906784f649eec33075a.png" width="492" height="111" class="jop-noMdConv">
- R1
...
- ![b62b6286f32755c891de60e648c6cb75.png](../../_resources/b62b6286f32755c891de60e648c6cb75.png)
...
- `show ip rip database`\- though v2 is classless, by default auto-summary summarizes net to classful boundaries (eg- 1.1.1.0/24 to 1.0.0.0/8)
    ...
    - <img src="../../_resources/9dcfcdde06e546aef4a87e6e49a7cc24.png" alt="9dcfcdde06e546aef4a87e6e49a7cc24.png" width="461" height="127" class="jop-noMdConv">
...
- ==We don't use RIP today because its not efficient as==
    ...
    - ==it uses hop count method (max-15 routers/hops)==
        - (In below eg RIP will choose path 2nd but path 3rd is best)
        - <img src="../../_resources/f4eaa2e6db01e887976c2358ee81768f.png" alt="f4eaa2e6db01e887976c2358ee81768f.png" width="327" height="160" class="jop-noMdConv">
...
2.  RIP v1
    ...
    - <img src="../../_resources/4f7f8235f0a19c220cab153bcfa97e73.png" alt="4f7f8235f0a19c220cab153bcfa97e73.png" width="420" height="96" class="jop-noMdConv"></img>
...
3.  RIP v1
    ...
    - <img src="../../_resources/21646008f824c7c06d9a6a9515a6e347.png" alt="21646008f824c7c06d9a6a9515a6e347.png" width="407" height="93" class="jop-noMdConv"></img>
        - comm from R1 to 10.3.3.3 & R3 to 10.1.1.1
            - ping possible due to contagious networks

- ==**SIR CONFUSED at 25.00 & 31.00 | cleared at 33:15**==