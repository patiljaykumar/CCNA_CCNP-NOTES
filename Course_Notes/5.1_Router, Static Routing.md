- Router starting info (not sure)
    ...
    - <img src="../resources/2864e76ff1217d7c53535c42172ede6e.png" alt="2864e76ff1217d7c53535c42172ede6e.png" width="396" height="476" class="jop-noMdConv">
- **Router**
...
- **Routing Table-** Collection of best active routes (best paths) `sh ip route`
    ...
    - `netstat -r`\- **![a0f3dd09ee6f4f4ba3b6745bb2dd804f.png](../resources/a0f3dd09ee6f4f4ba3b6745bb2dd804f.png)**
    - **RIB(Routing Information Base)**\- DB of all learned routes(static, conn, dynamic). Every protocol has its own RIB \[<ins>Control plane</ins> for route selection\] - `sh ip ospf database`, `sh ip eigrp topology`
        - <img src="../resources/f15fb5f6694bd9bbdeb52d955fe38cfe.png" alt="f15fb5f6694bd9bbdeb52d955fe38cfe.png" width="365" height="155" class="jop-noMdConv">
        - <img src="../resources/60e4599bd2fa546608a341eecaa3eb62.png" alt="60e4599bd2fa546608a341eecaa3eb62.png" width="335" height="159" class="jop-noMdConv">
    - ****FIB(Forwarding Information Base)-**** optimized version(subset) derived from RIB with best path used for forwarding. used by CEF,1 of 2 components of CEF(other is Adjacency table- next hop L2 info)
        ...
        - ![0ce8ea4e97d6bbb832ef19f22a91206f.png](../resources/0ce8ea4e97d6bbb832ef19f22a91206f.png)
        - <img src="../resources/b33e34f4bd0c57996f930c43641887f1.png" alt="b33e34f4bd0c57996f930c43641887f1.png" width="262" height="135" class="jop-noMdConv">
...
4.  **Floating static route**
    ...
    - when we shutdown g0/0- 12.2 route will be added to RT
        ...
        - <img src="../resources/3b00ae5b6956ec1a655abd19149ef3a1.png" alt="3b00ae5b6956ec1a655abd19149ef3a1.png" width="600" height="93" class="jop-noMdConv"></img>
            - ==\[AD/metric\]- \[10/0\]==
5.  **Host route**
    ...
    - <img src="../resources/5a6f8bbea5f650a29d122a8a24312324.png" alt="5a6f8bbea5f650a29d122a8a24312324.png" width="278" height="154" class="jop-noMdConv">
...
6.  **Null Route**
    ...
    - <img src="../resources/0350e5d8258539de26aadfb0ea46f434.png" alt="0350e5d8258539de26aadfb0ea46f434.png" width="344" height="164" class="jop-noMdConv">
