...
- **Collision Domain(CD)**\- <ins>network segment(domain)</ins> where there's <ins>possibility of collision</ins> when 2/more nodes tries to comm simultaneously
    - <img src="../../_resources/8f5da8aca164eae89ac77146d34beea9.png" alt="8f5da8aca164eae89ac77146d34beea9.png" width="273" height="199" class="jop-noMdConv">\- <ins>Collision Domain=1 & Broadcast domain=1</ins>
    - <img src="../../_resources/41c40f121268fc489b09557fd839346a.png" alt="41c40f121268fc489b09557fd839346a.png" width="270" height="175" class="jop-noMdConv">\- <ins>CD=4 & BD=1</ins> (Switch- per port CD, single BD)
    - <img src="../../_resources/1039bad5b6ff26b66283e4f524b835b2.png" alt="1039bad5b6ff26b66283e4f524b835b2.png" width="345" height="226" class="jop-noMdConv">\- <ins>CD=6 & 1 BD=1</ins>
...
- **Unknown unicast flooding-** <ins>event</ins> when a network switch forwards a unicast frame to all L2 ports in VLAN (except the one it was received on) because no entry for packet dest-MAC in switchs MAC table (eg- sent packet to new/disconnected/max-age host on vlan10-floods in vlan, full MAC table of switch(2960- max 8k MAC enteries)) `sh mac-address-table count`
    - ==<ins>Unknown unicast flooding vs Broadcast msg</ins>\- in broadcast target MAC is12F, In UUF target MAC is known==
...
- ==**VLAN need**\- to reduce broadcast domain size, Higher bandwidth(avoiding Broadcast traffic/msgs), lower CPU Overhead (additional benefit- security from below attacks)==
    
    - <img src="../../_resources/e440c994f41f0bf7bddbd2c036d06625.png" alt="e440c994f41f0bf7bddbd2c036d06625.png" width="376" height="149" class="jop-noMdConv"></img>
...
- ==By default Switch is single broadcast domain- By default all ports of Switch are member of VLAN1==
    
- **Total VLANs= 4096 (0-4095) (Check Dot1Q for details)**
    
    - Ethernet frame structure with VLAN Tag
        
        - <img src="../../_resources/77e8e1674ab5161b5b89e9d914b116d1.png" alt="77e8e1674ab5161b5b89e9d914b116d1.png" width="442" height="141" class="jop-noMdConv">
    - VLAN ID- 12bits (VLAN size 2^12= 4096 (Switch max VLANs- 255-4096))
        
    - <img src="../../_resources/3ce8929832722aef0c5e39eb57124178.png" alt="3ce8929832722aef0c5e39eb57124178.png" width="606" height="148" class="jop-noMdConv">
...
- **Problem1- Comm btw PC1 & PC2 (not config & implemented- only to test knowledge)**
    ...
    - <img src="../../_resources/9b1fd8cdfd1c8d813d2b1931e91c5521.png" alt="9b1fd8cdfd1c8d813d2b1931e91c5521.png" width="430" height="206" class="jop-noMdConv">
...
- <ins>**Methods**</ins>
    ...
    1.  **Router with Separate Interfaces (Legacy Method)**
        ...
        - <img src="../../_resources/c43f7c30e2689fc1ac4ed66373220d36.png" alt="c43f7c30e2689fc1ac4ed66373220d36.png" width="164" height="266" class="jop-noMdConv">
    ...
    2.  **Router on a Stick (sub interfaces)**
        - <img src="../../_resources/63cbc2a682ba3ecbb282db56432a1b86.png" alt="63cbc2a682ba3ecbb282db56432a1b86.png" width="152" height="267" class="jop-noMdConv">
    ...
    3.  **L3 Switch (SVI(Switch Virtual Interface))**
        - <img src="../../_resources/9d49fadc031f8e6775b71c05940e1dea.png" alt="9d49fadc031f8e6775b71c05940e1dea.png" width="145" height="209" class="jop-noMdConv">
...
- ### **Dot1Q (IEEE 802.1Q) (4B tag)**
    ...
    - <img src="../../_resources/357e8c972074343125c8fde35bc5725a.png" alt="357e8c972074343125c8fde35bc5725a.png" width="423" height="135" class="jop-noMdConv">
...
- `ip routing`\- Enables routing on L3 SW globally (3550, 3850)
    
    - SW can route btw VLANs (inter-vlan routing)
    - SVIs (int VLANs) can act as gateway int `int vlan 10`, `ip add 192.168.10.1 255.255.255.0`, `no sh`
- `no switchport`\- changes single physical port/int from L2(switchport) to L3(routed port) int
    
    - No VLAN tagging/ access/ trunking  |  No STP
- eg-
